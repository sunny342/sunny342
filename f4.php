...
<body>
    ...
    <div class="contact-section">
        ...
        <form class="contact-form" action="f5.php" method="post">
            <br><br>
            <br>
            <input type="text" class="contact-form-text" placeholder="new password" name="new">
            <br><br>
            <br>
            <center> <button type="sabmit" class="btn" name="email" >Update</button></center>
            <br>
        </form>
        <br><br><br>
